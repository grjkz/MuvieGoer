...
adventChildren = Movie.create({
	...
	image: File.new("https://s3.amazonaws.com/staticfilestoreage/muviegoer/seed/ffvii_poster.jpg")
	})
batmanVSuperman = Movie.create({
	...
	image: File.new("https://s3.amazonaws.com/staticfilestoreage/muviegoer/seed/batmanvsuperman.jpg")
	})
pulpFiction = Movie.create({
	...
	image: File.new("https://s3.amazonaws.com/staticfilestoreage/muviegoer/seed/pulpfiction.jpg")
	})
