...
adventChildren = Movie.create({
	...
	#image: File.new("https://s3.amazonaws.com/staticfilestoreage/muviegoer/seed/ffvii_poster.jpg") #File.new("#{Rails.root}/public/system/movies/seed/ffvii_poster.jpg")
	})
batmanVSuperman = Movie.create({
	...
	#image: File.new("https://s3.amazonaws.com/staticfilestoreage/muviegoer/seed/batmanvsuperman.jpg") #File.new("#{Rails.root}/public/system/movies/seed/batmanvsuperman.jpg")
	})
pulpFiction = Movie.create({
	...
	#image: File.new("https://s3.amazonaws.com/staticfilestoreage/muviegoer/seed/pulpfiction.jpg") #File.new("#{Rails.root}/public/system/movies/seed/pulpfiction.jpg")
	})
