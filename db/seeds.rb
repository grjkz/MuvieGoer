...
adventChildren = Movie.create({
	...
	image: File.open("#{Rails.root}/public/system/movies/seed/ffvii_poster.jpg")
	})
batmanVSuperman = Movie.create({
	...
	image: File.open("#{Rails.root}/public/system/movies/seed/batmanvsuperman.jpg")
	})
pulpFiction = Movie.create({
	...
	image: File.open("#{Rails.root}/public/system/movies/seed/pulpfiction.jpg")
	})
